...
namespace PocketMall.Migrations
{
    ...
    [Migration("20230625114621_addTotalPrice2")]
    partial class addTotalPrice2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PocketMall.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OrderProduct", b =>
                {
                    b.HasOne("PocketMall.Models.Order", null)
                        .WithMany()
                        .HasForeignKey("OrdersOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PocketMall.Models.Product", null)
                        .WithMany()
